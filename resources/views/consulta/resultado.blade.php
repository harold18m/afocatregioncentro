    ...
    <main class="contenedor w-11/12 md:w-1/2  my-5 mx-auto py-5 px-10 text-white">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="text-center my-4 flex flex-col md:flex-row justify-around">
                <a href="{{ route('consultar-cat') }}" class="nosubmit px-4 py-2 mb-2 md:mb-0 md:mr-5 w-full md:w-1/2 text-center">Regresar</a>
                <button onclick="location.href='{{ route('imprimir-soat') }}'" class="submit px-4 py-2 text-white w-full md:w-1/2 text-center">Generar</button>
            </div>
        @else
            ...
            <div class="text-center my-4 flex flex-col md:flex-row justify-around">
                <a href="{{ route('consultar-cat') }}" class="nosubmit px-4 py-2 mb-2 md:mb-0 md:mr-5 w-full md:w-1/2 text-center">Nueva Consulta</a>
